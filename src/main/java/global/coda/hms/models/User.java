...
public class User {
	...
	public String toString() {
		return "User [pkUserId=" + pkUserId + ", userUsername=" + userUsername
		    + ", userPassword=" + userPassword
		    + ", userEmail=" + userEmail + ", userPhonenumber=" + userPhonenumber
		    + ", userFirstname="
		    + userFirstname + ", userLastname=" + userLastname + ", userAge="
		    + userAge + ", userCity=" + userCity
		    + ", userState=" + userState + ", userStreet=" + userStreet
		    + ", fkRoleId=" + fkRoleId
		    + ", userIsactive=" + userIsactive + ", userCreatedOn=" + userCreatedOn
		    + ", userUpdatedOn="
		    + userUpdatedOn + "]";
	}
