...
public class Patient extends User {
	...
	public String toString() {
		return "Patient [pkPatientId=" + pkPatientId + ", patientHeight="
		    + patientHeight + ", patientWeight="
		    + patientWeight + ", patientIsactive=" + patientIsactive
		    + ", patientCreatedOn=" + patientCreatedOn
		    + ", patientUpdatedOn=" + patientUpdatedOn + ", fkUserid=" + fkUserid
		    + ", patientBloodGroup="
		    + patientBloodGroup + ", getPkUserId()=" + getPkUserId()
		    + ", getUserUsername()=" + getUserUsername()
		    + ", getUserPassword()=" + getUserPassword() + ", getUserEmail()="
		    + getUserEmail()
		    + ", getUserPhonenumber()=" + getUserPhonenumber()
		    + ", getUserFirstname()=" + getUserFirstname()
		    + ", getUserLastname()=" + getUserLastname() + ", getUserAge()="
		    + getUserAge() + ", getUserCity()="
		    + getUserCity() + ", getUserState()=" + getUserState()
		    + ", getUserStreet()=" + getUserStreet()
		    + ", getFkRoleId()=" + getFkRoleId() + ", getUserIsactive()="
		    + getUserIsactive()
		    + ", getUserCreatedOn()=" + getUserCreatedOn() + ", getUserUpdatedOn()="
		    + getUserUpdatedOn() + "]";
	}
